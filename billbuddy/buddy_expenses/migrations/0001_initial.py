    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('who_settle_simple_payment_up', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buddy_profiles.buddyprofile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('amount_payment', models.DecimalField(decimal_places=3, default=0, max_digits=8, verbose_name='Amount payment')),
                ('what_expense_belong_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buddy_expenses.buddyexpense')),
                ('who_do_simple_payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buddy_profiles.buddyprofile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='buddy_profiles.buddyprofile')),
            ],
            options={
                'abstract': False,
            },
